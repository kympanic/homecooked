		...
		<div>
			...
			{ user?.id === sessionUserId ? (
				<div>
					...
					<div> Note that this is the only means to edit profile image (when have you ever put in a profile image on sign up?)</div>
					<button>Change Password</button>
					<div> Note that this is the only way to change your password.</div>
				</div>
				) : null
			}
			{user?.shopName ? (
				...
				<div> 
					...
					<div> Note that this and a nav bar button are the only way to access this form. </div>
				</div>
				) : null
			)}
			<div> 

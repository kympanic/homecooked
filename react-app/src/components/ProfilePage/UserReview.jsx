...
const UserReview = ({ user, review }) => {
	...
	const specificReview = allReviews.filter(
		(el) => el.userId === review.userId && el.productId === review.productId
	);
	...
	return (
		<div className="singleReview">
			...
			<div className="linkAndButtonBox">
				<Link className="storeLink" to={`/store/${product.userId}`}>
					Go to the store that sells this item
				</Link>

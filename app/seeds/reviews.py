...
def seed_reviews():
    ...
    review4 = Review(rating = '3.5', body = "This is a test review4", user_id = 1, product_id = 7)
    review5 = Review(rating = '4.2', body = "This is a test review5", user_id = 1, product_id = 8)
    ...
    review13 = Review(rating = '5.0', body = "This is a test review13", user_id = 3, product_id = 4)
    review14 = Review(rating = '2.4', body = "This is a test review14", user_id = 3, product_id = 5)
    review15 = Review(rating = '2.8', body = "This is a test review15", user_id = 3, product_id = 6)

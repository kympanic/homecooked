...
def seed_products():
    product1 = Product(
        user_id=1, name='Burrito', description='Melt in your mouth goodness', image_url = 'https://www.pexels.com/photo/man-smiling-behind-wall-220453/',profile_img = 'https://www.pexels.com/photo/man-smiling-behind-wall-220453/', price=12.50)
    # marnie = User(
